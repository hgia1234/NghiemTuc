...
-(UIImage *) resizableImageWithCapInsetsStretch: (UIEdgeInsets) inset {
    ...
    {
        return [self stretchableImageWithLeftCapWidth:inset.left+inset.right topCapHeight:inset.top];
    }
}
